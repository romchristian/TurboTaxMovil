...
import turbotaxmovil.ideaspymes.com.py.turbotaxmovil.MainActivity;
import turbotaxmovil.ideaspymes.com.py.turbotaxmovil.R;
import turbotaxmovil.ideaspymes.com.py.turbotaxmovil.utils.PackageManagerUtils;
import turbotaxmovil.ideaspymes.com.py.turbotaxmovil.utils.PermissionUtils;

public class FacturaActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String CLOUD_VISION_API_KEY = "AIzaSyAiEqA5i8r5DASp4mEWE9sWoNsh-3Hn4ng";
    ...
    private void finalizar() {
        //Toast.makeText(getApplicationContext(), getText(timbrado)+"\n"+getText(numero)+"\n"+getText(ruc)+"\n"+getText(monto),Toast.LENGTH_LONG).show();
        //finish();

        AlertDialog.Builder builder = new AlertDialog.Builder(FacturaActivity.this);
        builder
                .setMessage("Elige el medio")
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == GALLERY_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            Uri photoUri = FileProvider.getUriForFile(this, ".fileProvider", getCameraFile());
